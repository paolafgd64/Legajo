...
urlpatterns = [
    ...
    path('api/admin/libros/reporte', views.api_admin_libros_reporte, name='api_admin_libros_reporte'),
    path('api/admin/libros/<int:libro_id>/estado', views.api_admin_actualizar_estado_libro, name='api_admin_actualizar_estado_libro'),
